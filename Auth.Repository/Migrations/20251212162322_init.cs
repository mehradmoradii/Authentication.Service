        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppGroups_AppGroups_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUrls_AppProjects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppGroupUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLogins", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppLogins_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppProfileImage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppProfileImage_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppGroupUrls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppGroupUrls_AppGroups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "AppGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppGroupUrls_AppUrls_UrlId",
                        column: x => x.UrlId,
                        principalTable: "AppUrls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AppGroups_ParentId",
                table: "AppGroups",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppGroupUrls_GroupId",
                table: "AppGroupUrls",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_AppGroupUrls_UrlId",
                table: "AppGroupUrls",
                column: "UrlId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLogins_UserId",
                table: "AppLogins",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppProfileImage_UserId",
                table: "AppProfileImage",
                column: "UserId",
                unique: true);
